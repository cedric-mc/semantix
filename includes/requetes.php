<?php
    ...
    $allFriends = "SELECT DISTINCT u.num_user, u.pseudo, u.email, u.annee_naissance, f.statut, u.photo FROM sae_users u JOIN sae_friendship f ON u.num_user = f.friend_id OR u.num_user = f.user_id WHERE (f.user_id = :num_user OR f.friend_id = :num_user) AND u.num_user <> :num_user;";
