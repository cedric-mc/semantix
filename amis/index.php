                ...
                <div class="users row row-cols-auto">
                    <?php $nbAmis = count($myFriendsResult); foreach ($myFriendsResult as $ligne) { ?>
                        <div class="user">
                            ...
                            <?php
                                if ($ligne->statut == 0) {
                                    echo "<a class='btn btn-warning' href='script-friend.php?accept&friendId=$ligne->num_user' role='button'>Accepter&emsp;<i class='fa-solid fa-check'></i></a>";
                                    echo "<a class='btn btn-danger' href='script-friend.php?refuse&friendId=$ligne->num_user' role='button'>Refuser&emsp;<i class='fa-solid fa-xmark'></i></a>";
                                } else {
                                    echo "<a class='btn btn-danger' href='#' role='button'>Supprimer&emsp;<i class='fa-solid fa-trash'></i></a>";
                                }
                            ?>
                        </div>
                    <?php } if ($nbAmis == 0) { ?>
