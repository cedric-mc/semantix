                    ...
                    <div class="user">
                        ...
                        <?php if ($ligne->statut == 0 && $ligne->acceptF == $idUser) { ?>
                            <a class="btn btn-warning"
                               href="script-friend.php?accept&friendId=<?php echo $ligne->num_user; ?>" role="button">Accepter&emsp;<i
                                        class="fa-solid fa-check"></i></a>
                            <a class="btn btn-danger"
                               href="script-friend.php?refuse&friendId=<?php echo $ligne->num_user; ?>" role="button">Refuser&emsp;<i
                                        class="fa-solid fa-xmark"></i></a>
                        <?php } elseif ($ligne->statut == 0 && $ligne->creatorF == $idUser) { ?>
                            <span class="text-muted">En attente de l'acceptation de l'ami</span>
                        <?php } else { ?>
                            <a class="btn btn-danger"
                               href="script-friend.php?delete&friendId=<?php echo $ligne->num_user; ?>" role="button">Supprimer&emsp;<i
                ...
                <?php if (isset($friendSearchResult)) { ?>
                    <?php foreach ($friendSearchResult as $ligne) { ?>
                        <div class="user">
                            ...
                            <p><?php echo $ligne->pseudo; ?></p>
                            <p><?php echo friendStatus($ligne->statut); ?></p>
                            <?php if (friendStatus($ligne->statut) == "Statut : En attente") { ?>
                                <a class="btn btn-warning"
                            ...
                            <?php } elseif (friendStatus($ligne->statut) == "Statut : Ami") { ?>
                                <a class="btn btn-danger"
                            ...
                            <?php } else { ?>
                                <a class="btn btn-success"
                                   href="script-friend.php?add&friendId=<?php echo $ligne->num_user; ?>" role="button">Ajouter&emsp;<i
